...
<details><summary>Чтобы всё правильно работало...</summary>
...
В "Сетевые правила/Интернет-фильтры/Настройка DNS" - нужно добавить несколько DoT/DoH серверов. (у автора этих строк - добавлены следующие DoT):
